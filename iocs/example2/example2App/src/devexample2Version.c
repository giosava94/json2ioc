...
#include "example2Version.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = example2VERSION;
...
static lsidset devexample2Version = {
    5, NULL, NULL, NULL, NULL, read_string
};
epicsExportAddress(dset,devexample2Version);
